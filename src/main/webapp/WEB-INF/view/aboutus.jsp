...
<body>
    ...
    <section class="mid-navbar">
        ...
        <span style="font-size: 14px;"><img src="./call_24dp_000000_FILL0_wght400_GRAD0_opsz24.png" alt="">Mob-No :
            7061598448</span>
        <div class="mid-menu">
    ...
    <!-- Company members content  START-->


    <h2 class="com-mem-heading"><span class="mem-heading-1">company</span><span class="mem-heading-2"> members</span>
    </h2>

    <div class="card-1 card-1st">
        <!-- company members row-1  -->
        <div class="card card-body card-image-1">
            <img src="./1615263018762.jpg" class="card-img-top" alt="...">

            <h5 class="card-title">Sourav kumar singh</h5>
        ...
        <div class="card card-body card-image-2">
            <img src="./PIC.png" class="card-img-top" alt="...">

            <h5 class="card-title">Omkar kumar sandilay</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>


        </div>
        <div class="card card-body card-image-3">
            <img src="./sourav pic.png" class="card-img-top" alt="...">

            <h5 class="card-title">Aman Tiwari</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>


        </div>
        <div class="card card-body card-image-4">
            <img src="./Untitled design (1).png" class="card-img-top" alt="...">

            <h5 class="card-title">Hari Om prakash</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the
                card's content.</p>


        </div>
        <div class="card card-body card-image-5">
            <img src="./Untitled design (1).png" class="card-img-top" alt="...">
        ...
        <div class="card card-body card-image-6 medium-screen">
            <img src="./Untitled design (1).png" class="card-img-top" alt="...">
    ...
    <!-- company members row-2  -->
    <div>

        <div class=" card-1 card-2nd">
            <div class="card card-body card-image-6">
                <img src="./1615263018762.jpg" class="card-img-top" alt="...">
            ...
            <div class="card card-body card-image-7">
                <img src="./PIC.png" class="card-img-top" alt="...">
            ...
            <div class="card card-body card-image-8">
                <img src="./sourav pic.png" class="card-img-top" alt="...">
            ...
            <div class="card card-body card-image-9 medium-screen-remove">
                <img src="./Untitled design (1).png" class="card-img-top" alt="...">
